...
class Conf extends Basic
{
    ...
    {
        file_put_contents( '/link/config/net.json', json_encode($param,JSON_UNESCAPED_UNICODE|JSON_PRETTY_PRINT) );
    ...
    {
        file_put_contents( '/link/config/net2.json', json_encode($param,JSON_UNESCAPED_UNICODE|JSON_PRETTY_PRINT) );
    ...
    public function updatePasswdConf($param)
    {
        ...
        file_put_contents( '/link/config/passwd.json', json_encode($data,JSON_UNESCAPED_UNICODE|JSON_PRETTY_PRINT));
        return $this->handleRet("",'success','修改成功','save successfully');
    }

    public function updateVideoBufferConf($param)
    {
        file_put_contents( '/link/config/videoBuffer.json', json_encode($param,JSON_UNESCAPED_UNICODE|JSON_PRETTY_PRINT));
        exec( 'pkill Encoder' );
        return $this->handleRet("",'success','保存成功','save successfully');
    }
    ...
    {
        file_put_contents( '/link/config/ntp.json', json_encode($param,JSON_UNESCAPED_UNICODE|JSON_PRETTY_PRINT));
        return $this->handleRet("",'success','保存成功','save successfully');
    }
